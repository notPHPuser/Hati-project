...
function ApartmentsPage() {
  const [apartament, setApartment] = useState({ info: [] });
  const { id } = useParams();
  console.log(id);
  useEffect(() => {
    fetchOneApartament(id).then((data) => setApartment(data));
  });
    ...
    <>
      ...
      >
        ...
        <p style={{ position: 'absolute', fontSize: 18, zIndex: -1, top: -2, left: 45 }}>
          {apartament.info.description.squere} м<sup>2</sup>
        </p>
        <img
        ...
        <p style={{ position: 'absolute', fontSize: 18, zIndex: -1, top: -2, left: 270 }}>
          {apartament.info.description.squere_living} м<sup>2</sup>
        </p>
        <p
          style={{
            color: 'grey',
        ...
        >
          {apartament.info.description.floor}
        </p>
        <p
          style={{
            color: 'grey',
        ...
        <p style={{ position: 'absolute', fontSize: 18, zIndex: -1, top: -2, left: 510 }}>
          {apartament.description.squere_kitchen} м<sup>2</sup>
        </p>
        <p
          style={{
            color: 'grey',
        ...
        <p style={{ position: 'absolute', fontSize: 18, zIndex: -1, top: -2, left: 270, top: 80 }}>
          {apartament.info.description.bathroom}
        </p>
        <p
          style={{
            color: 'grey',
        ...
        <p style={{ position: 'absolute', top: 180 }}>{apartament.info.description.description}</p>
      </div> */}
    </>
  );
}
